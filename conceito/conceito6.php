...
?>
  ...
  <p>     # CONCEITO: Neste item avaliar se o técnico utilizou todos os
status corretamente de acordo com o processo de atendimento -
Linha do tempo (Deslocamento, Inicio, Refeição, etc).
 <hr>
