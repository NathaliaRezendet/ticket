<?php
    ...
    $numTicket = null; // Inicializa a variável $numTicket fora do switch
...
<body>
    ...
    <div class="container">
            ...
            <form method="post">
                ...
                <script>
                    function mostrarFiltroCliente() {
                        var selectedOption = document.getElementById("assunto1").value;
        ...
        <div class="geral">
                <p class="mt-3">Clique no botão abaixo para iniciar a contagem:</p>
                <p class="tarefa1">Iniciar tarefa 3?</p>
